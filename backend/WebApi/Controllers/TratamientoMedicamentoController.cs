...
namespace WebApi.Controllers
{
    ...
    public class TratamientoMedicamentoController : ControllerBase
    {
        private readonly ITratamientoMedicamentoService _service;

        public TratamientoMedicamentoController(ITratamientoMedicamentoService service)
        {
        ...
        [Authorize(Roles = "Administrador,ProfesionalSalud")]
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] TratamientoMedicamentoCreateDto dto)
        {
            ...
            var entity = new TratamientoMedicamento
            {
            ...
            return CreatedAtAction(nameof(GetById), new { id = creado.IdTratamientoMedicamento }, creado);
        }

        [Authorize(Roles = "Administrador,ProfesionalSalud")]
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] TratamientoMedicamentoUpdateDto dto)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new { message = "La solicitud contiene datos invalidos." });
