...
namespace WebApi.Controllers
{
    ...
    public class AlertaController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            if (!filtrado.Any())
            {
                return Ok(new { message = "No hay registros de Alerta para tu cuenta." });
            }
            return Ok(filtrado);
        }
        ...
        public async Task<IActionResult> Create([FromBody] AlertaCreateDto dto)
        {
            ...
            var entity = new Alerta
            {
                ...
                IdIndicadorSalud = dto.IdIndicadorSalud,
                IdRecordatorio = dto.IdRecordatorio,
                Titulo = dto.Titulo,
                Mensaje = dto.Mensaje,
            ...
            return CreatedAtAction(nameof(GetById), new { id = creado.IdAlerta }, creado);
        }
        ...
        public async Task<IActionResult> Update(long id, [FromBody] AlertaUpdateDto dto)
        {
            ...
            var entity = new Alerta
            {
                ...
                IdIndicadorSalud = existente.IdIndicadorSalud,
                IdRecordatorio = existente.IdRecordatorio,
                Titulo = dto.Titulo,
                Mensaje = dto.Mensaje,
                TipoAlerta = dto.TipoAlerta,
                NivelPrioridad = dto.NivelPrioridad,
